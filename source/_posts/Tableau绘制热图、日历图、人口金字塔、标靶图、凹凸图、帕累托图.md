...
（4）按住 CTRL 键把销售额往后拖，即复制销售额这一栏，之后把第二个**总和（销售额）**改为**圆**，并点击**标签**，勾选**显示标记标签**和**允许标签覆盖其他标记**两个复选框,把对齐中的**水平与垂直**均设置为**居中**![image-20210913115428668](https://gitee.com/Omnivore_zhang/cloud-image/raw/master/Tableau/draw/image-20210913115428668.png)
